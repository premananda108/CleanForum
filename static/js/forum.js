...
class ForumAPI {
    ...
    // Moderator API
    async getPendingPosts(limit = 50, status = 'published', moderation = 'not_moderated') {
        return this.request(`/moderator/pending-posts?limit=${limit}&status=${status}&moderation=${moderation}`);
    }
